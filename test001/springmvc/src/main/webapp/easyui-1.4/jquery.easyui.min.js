...
$.messager.defaults=$.extend({},$.fn.window.defaults,{ok:"Ok",cancel:"Cancel",width:400,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
}});
})(jQuery);
(function($){
...
if(col){
var _794=_791[_793];
if(typeof col.styler=="string" && col.styler.length > 0){
...
if(col.formatter){
if(typeof col.formatter=="string" && col.formatter.length > 0){
...
return $(_b10).datebox("options").cleanText;
},handler:function(_b11){
$(_b11).combo('setValue', '').combo('setText', '');  
$(this).closest("div.combo-panel").panel("close");
}}],formatter:function(date){
...
return $(_b20).datebox("options").cleanText;
},handler:function(_b21){
$(_b21).combo('setValue', '').combo('setText', '');  
$(this).closest("div.combo-panel").panel("close");
}}],formatter:function(date){
var h=date.getHours();
